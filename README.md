...
La commande à executer pour cela est :
 <br/><br/> save(addr_folder="",filepath="", frame_start=0, frame_end=300, fps=25.0)
...
>   <br/><br/> Prend les fichiers objets de 1 à 5 pour en faire un fichier MDD à la racine du disque C
